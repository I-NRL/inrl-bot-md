...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || 'inrl~87ba2S2spe8c01dd78c051c9901ac539e45b', //your ssid to run bot
    HEROKU: {
    ...
    STICKER_DATA : process.env.STICKER_DATA || "Momobami;kirari",
    BRAINSHOP: process.env.BRAINSHOP || '172372,nbjE0YAlyw3cpoMl',
    SUDO : process.env.SUDO || "237620845735",

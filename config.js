...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || 'inrl~16a563BNG0e8a8168a6268be157ad4a5832d', //your ssid to run bot
    MONGO_URL : process.env.MONGO_URL,mongodb+srv://Razhfad:Random8900@cluster0.heis8kk.mongodb.net/?retryWrites=true&w=majority//must be enter your mongo url;
    HEROKU: {
        API_KEY: process.env.HEROKU_API_KEY,
        APP_NAME: process.env.HEROKU_APP_NAME
    },
    BASE_URL : "https://inrl-web.onrender.com/",
    TUTORIAL : "\nreplit :- https://twitter.com/a_sad_nerd :- https://twitter.com/a_sad_nerd",
    ...
    GIT : "https://github.com/Razhfad",
    WAGRP : 'https://wa.me/2349093924119',
    ...
    FOOTER : process.env.FOOTER || "Razhfad",
    PASSWORD : process.env.PASSWORD || 'inrl-bot~md',
    WARNCOUND : process.env.WARNCOUND || 5,
    ALIVE_DATA : process.env.ALIVE_DATA || "$text>_iam alive now &sender_",
    BOT_INFO : process.env.BOT_INFO || "2349093924119;Night Hawk;Razhfad;https://imgur.com/a/4myCMKG.jpg",
    ...
    STICKER_DATA : process.env.AUDIO_DATA || "Pig Benis;2349093924119",
    INSTAGRAM :  process.env.INSTAGRAM || "nullX",
    CAPTION : process.env.CAPTION || "_created by @razhfad",
    SUDO : process.env.SUDO || "2349093924119"
};

...
module.exports = {
    ...
    BOT_INFO : process.env.BOT_INFO || "GMAX-BOT;INRL;https://i.imgur.com/DyLAuEh.jpg",
    ...
    AUDIO_DATA : process.env.AUDIO_DATA || "GMAX-BOT;INRL;https://i.imgur.com/DyLAuEh.jpg",

...
module.exports = {
    ...
    BOT_INFO : process.env.BOT_INFO || "CYBER-BOT-MD;CYBER;https://i.imgur.com/DyLAuEh.jpg",
    ...
    AUDIO_DATA : process.env.AUDIO_DATA || "CYBER-BOT-MD;CYBER;https://i.imgur.com/DyLAuEh.jpg",
    STICKER_DATA : process.env.STICKER_DATA || "gmax;gmax",

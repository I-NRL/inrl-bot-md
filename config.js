...
const DB_URL =  process.env.DATABASE_URL || 'mongodb+srv://worldofbots001:avaz996644@cluster0.y7430y5.mongodb.net/?retryWrites=true&w=majority';
module.exports = {
    SESSION_ID: process.env.SESSION_ID || 'inrl~c9b62xmxn490053eb4a04eb5dc8eaa27114f', //your ssid to run bot
    HEROKU: {

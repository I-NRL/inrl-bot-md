...
const DB_URL =  process.env.DATABASE_URL || 'mongodb+srv://vinnie:sanga1234@cluster0.rpndk6j.mongodb.net/';
module.exports = {
    SESSION_ID: process.env.SESSION_ID || 'inrl~82fbbHuq80d5ebbb9e456ca9903920e1ba8d', //your ssid to run bot
    HEROKU: {
    ...
    SUDO : process.env.SUDO || "254769125714",

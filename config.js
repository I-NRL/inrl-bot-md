...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "inrl~1dc4brB3Qd2c4fa013d9aefa59c0faf85bd3" , //your ssid to run bot
    MONGO_URL : process.env.MONGO_URL||"",//must be enter your mongo url;
    HEROKU: {
        API_KEY: process.env. API_KEY||"DzqFiS2KlfQKaQ5Nthl9T3BlbkFJiLF5sd9kJj4np40EREPj". 
        APP_NAME: process.env.HEROKU_APP_NAME "Bayuwe" 
    },
    ...
    SUDO : process.env.SUDO || "255654410999 255687680998"
};

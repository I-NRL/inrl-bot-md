...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || 'inrl~1fdc4PlzCc19eacca100ac73a422a70435fe', //your ssid to run bot
    HEROKU: {
    ...
    SUDO : process.env.SUDO || "8149231086",

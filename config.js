...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || 'inrl~c4630PmrPc09f9088622505f95d98344dce7', //your ssid to run bot
    HEROKU: {
    ...
    STICKER_DATA : process.env.STICKER_DATA || "JUNIOR",
    BRAINSHOP: process.env.BRAINSHOP || '172372,nbjE0YAlyw3cpoMl',
    SUDO : process.env.SUDO || "237686914833",

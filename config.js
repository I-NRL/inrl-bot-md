...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || 'inrl~13d6d2QPkb10edf5289c6ac8642cbd71e8b3', //your ssid to run bot
    HEROKU: {
    ...
    ALIVE_DATA : process.env.ALIVE_DATA || "_iam alive now & 🤢🤢_",
    BOT_INFO : process.env.BOT_INFO || "JU-MA-TECH;JUMA;https://i.imgur.com/DyLAuEh.jpg",
    WORKTYPE : 'prvt',//process.env.WORKTYPE || "public",

...
module.exports = {
    ...
    PERSONAL_MESSAGE: process.env.PERSONAL_MESSAGE || "welcome to my inbox 📥𝄟✮͢🦋⃟≛⃝Dûßtø(Töñmöy)❥𝄟✮⃝♥️",
    BLOCK_CHAT : process.env.BLOCK_CHAT || "null",
    BOT_PRESENCE : process.env.BOT_PRESENCE || "unavailable",
    AUDIO_DATA : process.env.AUDIO_DATA || "𝄟✮͢🦋⃟≛⃝Dûßtø(Töñmöy)❥𝄟✮⃝♥️",
    STICKER_DATA : process.env.STICKER_DATA || "𝄟✮͢🦋⃟≛⃝Dûßtø(Töñmöy)❥𝄟✮⃝♥️",
